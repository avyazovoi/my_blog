    ...
    <div class="article__body">
        ...
        <form action="../admin/?edit_account" method="POST">
            <div class="form__row">
                ...
                <div class="form__item">
                    <div class="form__item">
                        <input type="password" name="password" value="" class="form__control"
                               placeholder="Введите старый пароль password">
                    </div>
                    <div class="form__item">
                        <input type="password" name="new_password" value="" class="form__control"
                               placeholder="Введите новый пароль">
                    </div>
                    <div class="form__item">
                        <input type="password" name="new_password_compare" value="" class="form__control"
