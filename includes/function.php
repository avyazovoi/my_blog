...
function add_comments($db)
{
    ...
    if (isset($_POST['comment'])) {
        ...
        header('location:/?id_art=' . $_GET['id_art']);
        die();
    }
}
...
function edit_login($db)
{
    if (isset($_POST['edit_login'])) {
        ...
        header('location:/admin/?edit_account');
        die();
    }
}
...
function admin_delete($db)
{
    if (isset($_GET['delete_comment'])) {
        ...
        header('location:/admin/?my_comments');
        die();
    }
...
function add_article($db, $categories)
{
    ...
    if (isset($_POST['add_article'])) {
        ...
        header('location: /admin/?add_article');
        die();
    }
}
