	...
	<form method="POST" class="form">
		<div class="form__body_row">
			<div class="form__item">
				<input type="text" name="username" value="<?= $_POST['username'] ?>" placeholder="Ваше имя" class="form__control" value="">
				<input type="email" name="email" value="<?= $_POST['email'] ?>" placeholder="Ваш email" class="form__control" value="">
			</div>
			<div class="form__item">
